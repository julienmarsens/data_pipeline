...
def make_signal_angle_figure(df: pd.DataFrame, pair_lbl: str,
                             thresh_deg: float = 4.0) -> plt.Figure:
    # 1 ── Date index
    ...
    # Panel 3 — Rolling angle + percentile bands  ← UPDATED
    ...
    ax2.set_title('Rolling 10-day angle with P10/P90 bands')
