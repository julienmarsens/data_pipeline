...
int main(int argc, char** argv) {
  ...
  std::string normalizedSignalVector_0{}, normalizedSignalVector_1{}, normalizedTradingVector_0{}, normalizedTradingVector_1{}, margin{}, stepback{}, typicalOrdersize{}, nc2l{}, maxInventory{};
  ...
  p->getValue("MAX_INVENTORY", maxInventory);  
  ...
  //if (eventHandler.tradingMode == EventHandlerBase::TradingMode::PAPER || eventHandler.tradingMode == EventHandlerBase::TradingMode::BACKTEST) {
    ...
    eventHandler.maxInventory = std::stod(maxInventory); 
