    ...
    */
    ...
    if (eventType == Event::Type::SUBSCRIPTION_DATA) {
      ...
      for (int i = 0; i < messageList.size(); ++i) {
        ...
        std::string productId = correlationIdTocken.at(1);
        std::string traderId;
        if (this->exchange_a == "okx" || this->exchange_b == "okx") traderId = correlationIdTocken.at(2);

        bool isValidClient = true;
        if ((message.getType() == Message::Type::EXECUTION_MANAGEMENT_EVENTS_PRIVATE_TRADE ||
             message.getType() == Message::Type::EXECUTION_MANAGEMENT_EVENTS_ORDER_UPDATE) &&
            (this->exchange_a == "okx" || this->exchange_b == "okx")) {
          const auto& elementsOKX = message.getElementList();
          auto elementOKX = elementsOKX.at(0);

          std::string clientOrderId = elementOKX.getValue("CLIENT_ORDER_ID");
          auto clientIdTocken = UtilString::split(clientOrderId, 'z');
          std::string trdIdMessage = clientIdTocken.at(1);

          std::string trdIdInstance = this->trader_id;

          size_t pos = trdIdInstance.find('_');
          if (pos != std::string::npos) {
            trdIdInstance.erase(pos, 1);  // erase 1 character at position 'pos'
          }
          // prodBztrader1zSELLTaker
          isValidClient = (trdIdMessage == trdIdInstance) ? true : false;
        }
        ...
        if (message.getType() == Message::Type::MARKET_DATA_EVENTS_MARKET_DEPTH && message.getRecapType() == Message::RecapType::NONE) {
          index = i;
                    ...
                    !(this->exchange_a == "okx" || this->exchange_b == "okx")) ||
                   (traderId == this->trader_id && isValidClient && (this->exchange_a == "okx" || this->exchange_b == "okx") &&
                    message.getType() == Message::Type::EXECUTION_MANAGEMENT_EVENTS_PRIVATE_TRADE)) {  // ETODO
          ////////////////////////////////////////
          // if ((message.getType() == Message::Type::EXECUTION_MANAGEMENT_EVENTS_PRIVATE_TRADE ||
          //    message.getType() == Message::Type::EXECUTION_MANAGEMENT_EVENTS_ORDER_UPDATE) &&
          //   (this->exchange_a == "okx" || this->exchange_b == "okx")) {
          ...
          // END EXECUTION_MANAGEMENT_EVENTS_PRIVATE_TRADE
        } else if (message.getType() == Message::Type::EXECUTION_MANAGEMENT_EVENTS_ORDER_UPDATE && traderId == this->trader_id && isValidClient) {
          for (const auto& element : message.getElementList()) {
            ...
            if ((this->tradingMode == TradingMode::PAPER || this->tradingMode == TradingMode::BACKTEST) && productId == "prodA") {
              for (const auto& element : message.getElementList()) {
                ...
                if ((isBuyerMaker && this->openBuyOrder_a && takerPrice <= this->openBuyOrder_a.get().limitPrice) ||
                  ...
                  messagePrivateTrade.setCorrelationIdList({std::string(CCAPI_EM_PRIVATE_TRADE) + "#prodA#" + this->trader_id});
                  ...
                  messageOrderUpdate.setCorrelationIdList({std::string(CCAPI_EM_ORDER_UPDATE) + "#prodA#" + this->trader_id});
            ...
            if ((this->tradingMode == TradingMode::PAPER || this->tradingMode == TradingMode::BACKTEST) && productId == "prodB") {
              for (const auto& element : message.getElementList()) {
                ...
                if ((isBuyerMaker && this->openBuyOrder_b && takerPrice <= this->openBuyOrder_b.get().limitPrice) ||
                  ...
                  messagePrivateTrade.setTime(messageTime);
                  messagePrivateTrade.setTimeReceived(messageTime);
                  messagePrivateTrade.setCorrelationIdList({std::string(CCAPI_EM_PRIVATE_TRADE) + "#prodB#" + this->trader_id});
                  // messagePrivateTrade.setCorrelationIdList({PRIVATE_SUBSCRIPTION_DATA_CORRELATION_ID});
                  Element elementPrivateTrade;
                  elementPrivateTrade.insert(CCAPI_TRADE_ID, std::to_string(++this->virtualTradeId_b));
                  elementPrivateTrade.insert(CCAPI_EM_ORDER_LAST_EXECUTED_PRICE, order.limitPrice.toString());
                  ...
                  messageOrderUpdate.setTime(messageTime);
                  messageOrderUpdate.setTimeReceived(messageTime);
                  messageOrderUpdate.setCorrelationIdList({std::string(CCAPI_EM_ORDER_UPDATE) + "#prodB#" + this->trader_id});
                  // messageOrderUpdate.setCorrelationIdList({PRIVATE_SUBSCRIPTION_DATA_CORRELATION_ID});
                  Element elementOrderUpdate;
                  // SWL rem missing : CCAPI_EM_ORDER_CUMULATIVE_FILLED_PRICE_TIMES_QUANTITY
                  elementOrderUpdate.insert(CCAPI_EM_ORDER_ID, order.orderId);
      ...
      if (index != -1) {
        ...
        // APP_LOGGER_DEBUG("midPriceA: " + std::to_string(this->midPriceA) + " midPriceB: " + std::to_string(this->midPriceB));
        if (this->tradingMode == TradingMode::PAPER || this->tradingMode == TradingMode::BACKTEST) {
          ...
          // APP_LOGGER_DEBUG("BestAskPriceA: " + this->bestAskPrice_a + " openBuyOrder_a: " + (this->openBuyOrder_a ? "true" : "false") +
          //                  " limitPriceA: " + (this->openBuyOrder_a ? this->openBuyOrder_a.get().limitPrice.toString() : "") + "buySideCrossed_a: " +
          //                  std::to_string(buySideCrossed_a));
          ...
          // APP_LOGGER_DEBUG("BestAskPriceB: " + this->bestAskPrice_b + " openBuyOrder_b: " + (this->openBuyOrder_b ? "true" : "false") +
          //                  " limitPriceB: " + (this->openBuyOrder_b ? this->openBuyOrder_b.get().limitPrice.toString() : "") + "buySideCrossed_b: " +
          //                  std::to_string(buySideCrossed_b));
          ...
          // APP_LOGGER_DEBUG("BestBidPriceA: " + this->bestBidPrice_a + " openSellOrder_a: " + (this->openSellOrder_a ? "true" : "false") +
          //                  " limitPriceA: " + (this->openSellOrder_a ? this->openSellOrder_a.get().limitPrice.toString() : "") + "sellSideCrossed_a: " +
          //                  std::to_string(sellSideCrossed_a));
          ...
          // APP_LOGGER_DEBUG("BestBidPriceB: " + this->bestBidPrice_b + " openSellOrder_b: " + (this->openSellOrder_b ? "true" : "false") +
          //                " limitPriceB: " + (this->openSellOrder_b ? this->openSellOrder_b.get().limitPrice.toString() : "") + "sellSideCrossed_b: " +
          //                std::to_string(sellSideCrossed_b));
          ...
          if ((buySideCrossed_a || sellSideCrossed_a) && this->marketImpfactFactor_a > 0) {
            ...
            if (abs(std::stod(filledAmount_std)) > 0) {
              ...
              message.setCorrelationIdList({std::string(PUBLIC_SUBSCRIPTION_DATA_TRADE_CORRELATION_ID) + "#prodA#" + this->trader_id});
          ...
          if ((buySideCrossed_b || sellSideCrossed_b) && this->marketImpfactFactor_b > 0) {
            ...
            if (abs(std::stod(filledAmount_std)) > 0) {
              ...
              message.setCorrelationIdList({std::string(PUBLIC_SUBSCRIPTION_DATA_TRADE_CORRELATION_ID) + "#prodB#" + this->trader_id});
              // legacy implementation of the correlation id
              // message.setCorrelationIdList({PUBLIC_SUBSCRIPTION_DATA_TRADE_CORRELATION_ID});
              std::vector<Element> elementList;
              Element element;
          ...
          if (instrument_name == this->instrument_a || instrument_name == this->instrument_b) {
            ...
            if (productId == "prodA") {
              ...
              if (this->exchange_b != "okx")
                this->remainingLiquidationQty_b = qty;  // TOCHECK FOR OKX
              ...
              if (productId == "prodA" && !this->isLiquidationOrderSent_a) {
                ...
                if (amountTaker_a != 0.0 && !this->isLiquidationOrderSent_a) {
                  ...
                  if (this->tradingMode == TradingMode::BACKTEST || this->tradingMode == TradingMode::PAPER) {
                    ...
                    aSellLevelTakerA = std::stod(this->bestBidPrice_a) -
                                       1000 * this->offset *
                                           abs(std::stod(this->bestBidPrice_a) -
                                               std::stod(this->bestAskPrice_a));  // sell into the order book == mkt order : BEWARE OF THE DUST...
                  ...
                  this->placeQuote(event, session, requestList, tpnow(), this->exchangePositionUSD_a > 0 ? aBuyLevelTakerA : aSellLevelTakerA, amountTaker_a,
              ...
              if (productId == "prodB" && !this->isLiquidationOrderSent_b) {
                ...
                if (amountTaker_b != 0.0 && !this->isLiquidationOrderSent_b) {
                  ...
                  if (this->tradingMode == TradingMode::BACKTEST || this->tradingMode == TradingMode::PAPER) {
                    ...
                    aSellLevelTakerB = std::stod(this->bestBidPrice_b) -
                                       1000 * this->offset *
                                           abs(std::stod(this->bestBidPrice_b) -
                                               std::stod(this->bestAskPrice_b));  // sell into the order book == mkt order : BEWARE OF THE DUST...
                  ...
                  this->placeQuote(event, session, requestList, tpnow(), this->exchangePositionUSD_b > 0 ? aBuyLevelTakerB : aSellLevelTakerB, amountTaker_b,
                                   productId == "prodB" ? 1 : 0, this->exchangePositionUSD_b > 0 ? 0 : 1, false);
              ...
              if (productId == "prodB" && !this->isLiquidationOrderSent_b) {
                ...
                if (amountTaker_b != 0.0 && !this->isLiquidationOrderSent_b) {
                  ...
                  this->placeQuote(event, session, requestList, tpnow(), amountTaker_b < 0 ? aSellLevelTakerB : aBuyLevelTakerB, abs(amountTaker_b),
                                   productId == "prodB" ? 1 : 0, amountTaker_b > 0 ? 0 : 1, false);
                }
              }
            }  // END POSITION RESET
      ...
      for (const auto& message : event.getMessageList()) {
        if (message.getType() == Message::Type::SESSION_CONNECTION_UP) {
          for (const auto& correlationId : message.getCorrelationIdList()) {
            if (correlationId == "PRIVATE_TRADE#prodA#" + this->trader_id) {
            ...
            if (correlationId == "PRIVATE_TRADE#prodB#" + this->trader_id) {
              const auto& messageTimeReceived = message.getTimeReceived();
              const auto& messageTimeReceivedISO = UtilTime::getISOTimestamp(messageTimeReceived);
      ...
      for (const auto& message : event.getMessageList()) {
        if (message.getType() == Message::Type::SUBSCRIPTION_STARTED) {
          ...
          for (const auto& correlationId : message.getCorrelationIdList()) {
            ...
            if (correlationId == "TRADE#prodA#" + this->trader_id) {
              this->is_subscription_started_trade_a = true;
            }
            if (correlationId == "TRADE#prodB#" + this->trader_id) {
              this->is_subscription_started_trade_b = true;
            }
            if (correlationId == "MARKET_DEPTH#prodA#" + this->trader_id) {
              this->is_subscription_started_mkt_depth_a = true;
            }
            if (correlationId == "MARKET_DEPTH#prodB#" + this->trader_id) {
              this->is_subscription_started_mkt_depth_b = true;
            }
            if (correlationId == "ORDER_UPDATE#prodA#" + this->trader_id) {
              this->is_subscription_started_order_update_a = true;
            }
            if (correlationId == "ORDER_UPDATE#prodB#" + this->trader_id) {
...
*/
  ...
  */
  ...
  bool enableUpdateOrderBookTickByTick = true;
  ...
  virtual void createSubscriptionList(std::vector<Subscription>& subscriptionList) {
    // market depth -> works -> for backtest the depth is all recorded depth
    {
      ...
      subscriptionList.emplace_back(this->exchange_a, this->instrumentWebsocket_a, CCAPI_MARKET_DEPTH, options,
                                    std::string(CCAPI_MARKET_DEPTH) + "#prodA#" + this->trader_id, this->credential_a);

      subscriptionList.emplace_back(this->exchange_b, this->instrumentWebsocket_b, CCAPI_MARKET_DEPTH, options,
                                    std::string(CCAPI_MARKET_DEPTH) + "#prodB#" + this->trader_id, this->credential_b);
    ...
    // public trade feeds -> works for binance...credentials issues for deribit
    {
      ...
      subscriptionList.emplace_back(this->exchange_a, this->instrumentWebsocket_a, field_a, "", std::string(CCAPI_TRADE) + "#prodA#" + this->trader_id,
                                    this->credential_a);
      subscriptionList.emplace_back(this->exchange_b, this->instrumentWebsocket_b, field_b, "", std::string(CCAPI_TRADE) + "#prodB#" + this->trader_id,
                                    this->credential_b);
...

    {
      ...
      subscriptionList.emplace_back(this->exchange_a, this->instrumentWebsocket_a, CCAPI_EM_PRIVATE_TRADE, "",
                                    std::string(CCAPI_EM_PRIVATE_TRADE) + "#prodA#" + this->trader_id, this->credential_a);
      subscriptionList.emplace_back(this->exchange_b, this->instrumentWebsocket_b, CCAPI_EM_PRIVATE_TRADE, "",
                                    std::string(CCAPI_EM_PRIVATE_TRADE) + "#prodB#" + this->trader_id, this->credential_b);
      //}
      // subscriptionList.emplace_back(this->exchange_a, this->instrumentWebsocket_a, CCAPI_EM_PRIVATE_TRADE, "",
    ...
    }
    {
      // if (this->tradingMode == TradingMode::LIVE) {
      subscriptionList.emplace_back(this->exchange_a, this->instrumentWebsocket_a, CCAPI_EM_ORDER_UPDATE, "",
                                    std::string(CCAPI_EM_ORDER_UPDATE) + "#prodA#" + this->trader_id, this->credential_a);
      subscriptionList.emplace_back(this->exchange_b, this->instrumentWebsocket_b, CCAPI_EM_ORDER_UPDATE, "",
                                    std::string(CCAPI_EM_ORDER_UPDATE) + "#prodB#" + this->trader_id, this->credential_b);
      //}
    }
    /*
    {
    ...
    if (this->previousCrossingMicro + deltaCrossingTime <= currentTimeMicro) {
      ...
      if ((!this->bestBidPrice_a.empty() && !this->bestAskPrice_a.empty() && !this->bestBidPrice_b.empty() && !this->bestAskPrice_b.empty()) &&
        ...
        */
        ...
        signalPrice_0 =
            std::stod(this->newBestBidPrice_a) * this->normalizedSignalVector_0 + std::stod(this->newBestAskPrice_b) * this->normalizedSignalVector_1;
        signalPrice_1 =
            std::stod(this->newBestAskPrice_a) * this->normalizedSignalVector_0 + std::stod(this->newBestBidPrice_b) * this->normalizedSignalVector_1;
        ...
        */
        ...
        APP_LOGGER_DEBUG("(signalPrice_0 - this->theoreticalPrice ) / this->margin: "+ std::to_string((signalPrice_0 - this->theoreticalPrice ) /
        this->margin)); APP_LOGGER_DEBUG("(this->theoreticalPrice - signalPrice_1 ) / this->margin: "+ std::to_string((this->theoreticalPrice - signalPrice_1 )
        / this->margin));
        */
        // end debug
        ...
        if (this->isDownwardCrossing || downwardCrossingCondition) {
          // if(this->isDownwardCrossing  || (this->lowerLimitReached_b && downwardCrossingCondition) || (this->upperLimitReached_a &&
          // downwardCrossingCondition))
        ...
        */
        ...
        if ((this->aBuyLevelA != this->anOldBuyLevelA || (this->aBuyLevelA != -1 && !this->openBuyOrder_a)) ||
          ...
          /*
                      ...
                      if(!this->upperLimitReached_a) {
                        APP_LOGGER_DEBUG("# Place quote A, side==buy");
                        this->placeQuote(event, session, requestList, messageTimeReceived, this->aBuyLevelA, this->orderAmount_a, 0, 0, true); // place ONE
             QUOTE, therefore one more open order } else { APP_LOGGER_DEBUG("# Risk limit reached, don't place quote A, side==buy");
                      }
                      // swl quoter, i.e. leg==0 -> leg a, leg==1 -> leg b ## side==0 -> buy, side==1 -> sell
                      if(!this->lowerLimitReached_a) {
                        APP_LOGGER_DEBUG("# Place quote A, side==sell");
        ...
        if ((this->aBuyLevelB != this->anOldBuyLevelB || (this->aBuyLevelB != -1 && !this->openBuyOrder_b)) ||
          ...
          /*
                      ...
                      if(!this->upperLimitReached_b) {
                        APP_LOGGER_DEBUG("# Place quote B, side==buy");
                        this->placeQuote(event, session, requestList, messageTimeReceived, this->aBuyLevelB, this->orderAmount_b, 1, 0, true); // place ONE
             QUOTE, therefore one more open order } else { APP_LOGGER_DEBUG("# Risk limit reached, don't place quote B, side==buy");
                      }
                      // swl quoter, i.e. leg==0 -> leg a, leg==1 -> leg b ## side==0 -> buy, side==1 -> sell
                      if(!this->lowerLimitReached_b) {
                        APP_LOGGER_DEBUG("# Place quote B, side==sell");
      ...
      }  // end check crossing timestamp increment
    }  // end on quote
        ...
        if (productId == "prodA") {
          ...
          if (this->isReinit && !this->isLiquidated_a) {
            ...
            if (this->remainingLiquidationQty_a == 0) {
              ...
              // if we liquidated the position b with a market order we still need to cancel potential open orders
              if (this->isLiquitation) {
                APP_LOGGER_INFO("# All position for leg A liquidated, then cancel all order for A.");
          ...
          if (this->isInitOrder && !this->isLiquidated_a) {
            ...
            if (this->remainingLiquidationQty_a == 0) {
              ...
              // if we liquidated the position a with a market order we still need to cancel potential open orders
              if (this->isLiquidationOrder) {
                APP_LOGGER_INFO("# All position for leg A liquidated, then cancel all order for A.");
                this->cancelAllOpenOrders(event, session, requestList, tpnow(), messageTimeReceivedISO, "prodA");
              }
          ...
          if (this->isReinit && !this->isLiquidated_b) {
            ...
            if (this->remainingLiquidationQty_b == 0) {
              ...
              // if we liquidated the position b with a market order we still need to cancel potential open orders
              if (this->isLiquitation) {
                APP_LOGGER_INFO("# All position for leg B liquidated, then cancel all order for B.");
...
*/
  ...
  */
    ...
    if (isLastOrderIdAvailable) {
      ...
      if (productId == "prodA") {
        if (side == "sell") {
          ...
          if (this->openSellOrder_a && !this->openSellOrder_a.get().orderId.empty()) {
            this->cancelSellOrderRequestCorrelationId_a = "CANCEL_SELL_ORDER#prodA#" + this->trader_id;
          ...
          if (this->openBuyOrder_a && !this->openBuyOrder_a.get().orderId.empty()) {
            this->cancelBuyOrderRequestCorrelationId_a = "CANCEL_BUY_ORDER#prodA#" + this->trader_id;
      ...
      if (productId == "prodB") {
        if (side == "sell") {
          ...
          // check that there exist open sell order for that leg
          if (this->openSellOrder_b && !this->openSellOrder_b.get().orderId.empty()) {
            this->cancelSellOrderRequestCorrelationId_b = "CANCEL_SELL_ORDER#prodB#" + this->trader_id;
          ...
          if (this->openBuyOrder_b && !this->openBuyOrder_b.get().orderId.empty()) {
            this->cancelBuyOrderRequestCorrelationId_b = "CANCEL_BUY_ORDER#prodB#" + this->trader_id;
  ...
  virtual void cancelAllOpenOrders(const Event& event, Session* session, std::vector<Request>& requestList, const TimePoint& messageTime,
    ...
    if (productId == "prodA") {
      ...
      this->cancelOpenOrdersRequestCorrelationId_a = "CANCEL_ALL_ORDERS#prodA#" + this->trader_id;
      ...
      this->cancelOpenOrdersRequestCorrelationId_b = "CANCEL_ALL_ORDERS#prodB#" + this->trader_id;
  ...
  */
  ...
  virtual void getAccountBalances(const Event& event, Session* session, std::vector<Request>& requestList, const TimePoint& messageTime,
    ...
    if (productId == "prodA") {
      Request request(this->useGetAccountsToGetAccountBalances_a ? Request::Operation::GET_ACCOUNTS : Request::Operation::GET_ACCOUNT_BALANCES,
                      this->exchange_a, "", this->getAccountBalancesRequestCorrelationId + "#prodA#" + this->trader_id, this->credential_a);
      ...
      Request request(this->useGetAccountsToGetAccountBalances_b ? Request::Operation::GET_ACCOUNTS : Request::Operation::GET_ACCOUNT_BALANCES,
                      this->exchange_b, "", this->getAccountBalancesRequestCorrelationId + "#prodB#" + this->trader_id, this->credential_b);
  ...
  virtual void getAccountPositions(const Event& event, Session* session, std::vector<Request>& requestList, const TimePoint& messageTime,
                                   const std::string& productId) {
    if (productId == "prodA") {
      Request request(Request::Operation::GET_ACCOUNT_POSITIONS, this->exchange_a, "", "GET_ACCOUNT_POSITIONS#prodA#" + this->trader_id, this->credential_a);
      ...
      Request request(Request::Operation::GET_ACCOUNT_POSITIONS, this->exchange_b, "", "GET_ACCOUNT_POSITIONS#prodB#" + this->trader_id, this->credential_b);
...
*/
  ...
  virtual Request createRequestForCreateOrder2L(const std::string& side, const std::string& price, const std::string& quantity, const TimePoint& now, int leg,
    ...
    Request request(Request::Operation::CREATE_ORDER, leg == 0 ? this->exchange_a : this->exchange_b,
                    leg == 0 ? this->instrumentRest_a : this->instrumentRest_b, "CREATE_ORDER_" + side + (leg == 0 ? "#prodA#" : "#prodB#") + this->trader_id,
    ...
    */
    ...
    std::string tmp = (leg == 0 ? "prodA" : "prodB");
    // APP_LOGGER_INFO("Place order - leg: " + tmp + " side: " + side + ", price: " + price + ", quantity: " + quantity + ".");
    return request;
  }
        ...
        */
        ...
        if (sufficientBalance) {
          ...
          message.setCorrelationIdList(
              {std::string(CCAPI_EM_PRIVATE_TRADE) + (productId == "prodA" ? "#prodA#" + this->trader_id : "#prodB#" + this->trader_id)});
        ...
        message.setCorrelationIdList({std::string(CCAPI_EM_ORDER_UPDATE) + (productId == "prodA" ? "#prodA#" + this->trader_id : "#prodB#" + this->trader_id)});
      ...
      if (operation == Request::Operation::CREATE_ORDER && productId == "prodA") {
        if (this->openBuyOrder_a || this->openSellOrder_a) {
          ...
          if (!elementListPrivateTrade.empty()) {
            ...
            {
              Message message;
              message.setCorrelationIdList({std::string(CCAPI_EM_PRIVATE_TRADE) + "#prodA#" + this->trader_id});
              // message.setCorrelationIdList({PRIVATE_SUBSCRIPTION_DATA_CORRELATION_ID});
            ...
            {
              Message message;
              message.setCorrelationIdList({std::string(CCAPI_EM_ORDER_UPDATE) + "#prodA#" + this->trader_id});
              // message.setCorrelationIdList({PRIVATE_SUBSCRIPTION_DATA_CORRELATION_ID});
              message.setType(Message::Type::EXECUTION_MANAGEMENT_EVENTS_ORDER_UPDATE);
              message.setTime(now);
              message.setTimeReceived(now);
      ...
      if (operation == Request::Operation::CREATE_ORDER && productId == "prodB") {
        if (this->openBuyOrder_b || this->openSellOrder_b) {
          ...
          if (!elementListPrivateTrade.empty()) {
            ...
            {
              Message message;
              message.setCorrelationIdList({std::string(CCAPI_EM_PRIVATE_TRADE) + "#prodB#" + this->trader_id});
              // message.setCorrelationIdList({PRIVATE_SUBSCRIPTION_DATA_CORRELATION_ID});
              message.setType(Message::Type::EXECUTION_MANAGEMENT_EVENTS_PRIVATE_TRADE);
              message.setTime(now);
              message.setTimeReceived(now);
            ...
            {
              Message message;
              message.setCorrelationIdList({std::string(CCAPI_EM_ORDER_UPDATE) + "#prodB#" + this->trader_id});
              // message.setCorrelationIdList({PRIVATE_SUBSCRIPTION_DATA_CORRELATION_ID});
              message.setType(Message::Type::EXECUTION_MANAGEMENT_EVENTS_ORDER_UPDATE);
              message.setTime(now);
              message.setTimeReceived(now);
