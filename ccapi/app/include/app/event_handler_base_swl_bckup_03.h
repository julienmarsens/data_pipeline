 ...
 */           
    ...
    */
          ...
          if(moveTheoPrice !=0) {
            ...
            // for prod A
            if(this->instrument_type_a != "INVERSE") {
              this->orderAmount_a = abs(cleanOrderAmount_a/this->midPriceA);
            } else {
              this->orderAmount_a = abs(cleanOrderAmount_a);
            }

            // for prod B
            if(this->instrument_type_b != "INVERSE") {
              this->orderAmount_b = abs(cleanOrderAmount_b/this->midPriceB);
            } else {
              this->orderAmount_b = abs(cleanOrderAmount_b);
            }
