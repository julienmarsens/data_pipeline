...
*/
  ...
  double normalizedSignalVector_0{}, normalizedSignalVector_1{}, margin{}, stepback{}, typicalOrderSize{}, nc2l{}, theoreticalPrice{}, anOldBuyLevelA = -1, anOldSellLevelA = -1, 
 ...
 protected:  
  ...
  //int deltaCrossingTime = 60; // number of sec between to occurences (beware mkt message rate...)
    ...
    if(this->previousSyncMicro + deltaSyncPortfolio < currentTimeMicro) {
      ...
      APP_LOGGER_DEBUG("#####################################################################################################");
      APP_LOGGER_DEBUG("##### Sync Exchange position with internal position");
