 ...
 protected:
  ...
  void extractAccountInfoFromRequest(std::vector<Element>& elementList, const Request& request, const Request::Operation operation,
    ...
    switch (request.getOperation()) {
      case Request::Operation::GET_ACCOUNT_BALANCES: {
        const auto& marginType = request.getMarginType();
        if (this->isDerivatives && !this->isDerivatives_pm) {
        ...
        } else if (this->isDerivatives && this->isDerivatives_pm) {
            /*
  {"uniMMR":"99999999","accountEquity":"23424.83425634","actualEquity":"24657.72026983","accountInitialMargin":"0.0","accountMaintMargin":"0.0","accountStatus":"NORMAL","virtualMaxWithdrawAmount":"23424.83425634","totalAvailableBalance":"23424.83425634","totalMarginOpenLoss":"0.0","updateTime":1720692312561}
[2024-07-11T10:05:12.573427121Z] {ccapi_service.h:251}  139831485130304: {ccapi_service.h:251} ERROR        errorMessage = rapidjson internal assertion failure
[2024-07-11T10:05:12.573440693Z] {ccapi_service.h:252}  139831485130304: {ccapi_service.h:252} ERROR        correlationIdList = [ GET_ACCOUNT_BALANCES#prodA ]
*/        
          // the response is not an array but a single entity containing account value in usdt
          std::string asset = "usdt";
          std::string actual_equity = document["actualEquity"].GetString();

          Element element;
          element.insert(CCAPI_EM_ASSET, asset);
          element.insert(CCAPI_EM_QUANTITY_AVAILABLE_FOR_TRADING, actual_equity);
          elementList.emplace_back(std::move(element));
