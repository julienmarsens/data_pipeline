...
class ExecutionManagementServiceBinanceCoinFutures : public ExecutionManagementServiceBinanceDerivativesBase {
 public:
  ExecutionManagementServiceBinanceCoinFutures(std::function<void(Event&, Queue<Event>*)> eventHandler, SessionOptions sessionOptions,
    ...
    this->isDerivatives_pm = false;

    // CCAPI_BINANCE_COIN_FUTURES_LISTEN_KEY_PATH "/dapi/v1/listenKey"
    this->listenKeyTarget = CCAPI_BINANCE_COIN_FUTURES_LISTEN_KEY_PATH;
    this->getAccountBalancesTarget = "/dapi/v1/account";
    this->getAccountPositionsTarget = "/dapi/v1/positionRisk"; // JFA


/*
// portfolio margin account
    this->createOrderTarget = "/papi/v1/cm/order";
    this->cancelOrderTarget = "/papi/v1/cm/order";
    this->getOrderTarget = "/papi/v1/cm/order";
    this->getOpenOrdersTarget = "/papi/v1/cm/openOrder";
    this->cancelOpenOrdersTarget = "/papi/v1/cm/allOpenOrders";
    this->isDerivatives = true;
    this->isDerivatives_pm = true;
    this->listenKeyTarget = "/papi/v1/listenKey";
    this->getAccountBalancesTarget = "/papi/v1/account";
    this->getAccountPositionsTarget = "/papi/v1/cm/positionRisk"; // JFA
*/
  }
