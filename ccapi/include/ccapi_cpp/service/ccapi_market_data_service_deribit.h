...
/*
{"jsonrpc":"2.0",
"id":1693507630479531000,
"method":"public/auth",
"params":{
"grant_type":"client_credentials",
"client_id":"sa2bkpJ0",
"client_secret":"6e3MfhLYsGNzXz4iiQmn5VdUu8TmGmfgvhkIhYjjADg"
}
}

"scope":"session:apiconsole-d8mxn77x3y5"

trade:read

{"jsonrpc":"2.0","id":1693507630479531000,"method":"public/auth","params":{"client_id":"1N8P15Ra","grant_type":"client_signature","nonce":"1693507630479",
"signature":"988f14492f4cc8b68db6d3483bf181dadef66e290176bca072f9a62e8a1d082b","timestamp":"1693507630479"}}
*/
  ...
  void processTextMessage(
    ...
    //CCAPI_LOGGER_INFO("#########################################################");
    //CCAPI_LOGGER_INFO("##### 1. WITHIN DATA SERVICE DERIBIT!!!");
    //CCAPI_LOGGER_INFO("#########################################################");
    ...
    if (it == document.MemberEnd()) {
      ...
      //CCAPI_LOGGER_INFO("#########################################################");
      //CCAPI_LOGGER_INFO("##### 2. WITHIN DATA SERVICE DERIBIT!!!");
      //CCAPI_LOGGER_INFO("#########################################################");
      ...
      if (it != document.MemberEnd()) {
        ...
        //CCAPI_LOGGER_INFO("#########################################################");
        //CCAPI_LOGGER_INFO("##### 2.1 WITHIN DATA SERVICE DERIBIT!!!");
        //CCAPI_LOGGER_INFO("#########################################################");

        int64_t id = std::stoll(it->value.GetString());

        //CCAPI_LOGGER_INFO("#########################################################");
        //CCAPI_LOGGER_INFO("##### 2.2 WITHIN DATA SERVICE DERIBIT!!!");

        //std::map<char,int>::iterator it_tmp;
        //CCAPI_LOGGER_INFO("##### 2.3 id->value: " + std::to_string(id));
        //auto it_tmp = this->subscriptionJsonrpcIdSetByConnectionIdMap.at(wsConnection.id).find(id);
        //CCAPI_LOGGER_INFO("##### 2.4 id->value: " + std::to_string(id));
        //CCAPI_LOGGER_INFO("##### 2.3 id->value: " + std::to_string(std::stoll(it_tmp->value.GetString()));
        //CCAPI_LOGGER_INFO("##### 2.4 this->subscriptionJsonrpcIdSetByConnectionIdMap.at(wsConnection.id).end(): " + this->subscriptionJsonrpcIdSetByConnectionIdMap.at(wsConnection.id).end());
        //CCAPI_LOGGER_INFO("#########################################################");
        ...
        if (this->subscriptionJsonrpcIdSetByConnectionIdMap.at(wsConnection.id).find(id) !=
          ...
          //CCAPI_LOGGER_INFO("#########################################################");
          //CCAPI_LOGGER_INFO("##### 3. WITHIN DATA SERVICE DERIBIT!!!");
          //CCAPI_LOGGER_INFO("#########################################################");
          if (document["result"].GetArray().Empty()) {

            //CCAPI_LOGGER_INFO("#########################################################");
            //CCAPI_LOGGER_INFO("##### 4. WITHIN DATA SERVICE DERIBIT!!!");
            //CCAPI_LOGGER_INFO("#########################################################");
            ...
            //CCAPI_LOGGER_INFO("#########################################################");
            //CCAPI_LOGGER_INFO("##### 5. WITHIN DATA SERVICE DERIBIT!!!");
            //CCAPI_LOGGER_INFO("#########################################################");
